...
export function addFlutterLayoutComponents(editor: any) {
  ...
  editor.BlockManager.add('flutter-scaffold', {
    ...
    content: `
      <section data-gjs-type="flutter-scaffold" style="display: flex; flex-direction: column; min-height: 100vh; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-radius: 18px; overflow: hidden;">
        <header data-gjs-type="flutter-app-bar" style="height: 64px; background: #1976d2; color: #fff; display: flex; align-items: center; padding: 0 24px; font-size: 1.25rem; font-weight: 600; letter-spacing: 0.02em; box-shadow: 0 2px 4px rgba(25,118,210,0.08);">
          App Title
        </header>
        <main data-gjs-type="flutter-body" style="flex: 1; padding: 32px 20px; background: #f7f7fa;">
          <div style="text-align: center; color: #888; font-size: 1.1rem;">Agrega contenido aquí</div>
        </main>
        <nav data-gjs-type="flutter-bottom-navigation-bar" style="height: 64px; background: #fff; border-top: 1px solid #e0e0e0; display: flex; justify-content: space-evenly; align-items: center; gap: 16px;">
  ...
  editor.BlockManager.add('flutter-container', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-container" style="background: #e3f2fd; border-radius: 12px; padding: 20px; margin: 16px 0; box-shadow: 0 1px 4px rgba(33,150,243,0.08); display: flex; align-items: center; justify-content: center; min-height: 60px;">
  ...
  editor.BlockManager.add('flutter-row', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-row" style="display: flex; flex-direction: row; gap: 16px; width: 100%; padding: 12px; margin: 16px 0; background: #f5f5f5; border-radius: 12px; align-items: center; overflow-x: auto;">
  ...
  editor.BlockManager.add('flutter-column', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-column" style="display: flex; flex-direction: column; gap: 16px; width: 100%; padding: 12px; margin: 16px 0; background: #f5f5f5; border-radius: 12px;">
  ...
  editor.BlockManager.add('flutter-stack', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-stack" style="position: relative; width: 100%; height: 160px; background: #eeeeee; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-expanded', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-expanded" style="flex: 1; background: #ede7f6; min-height: 40px; border-radius: 12px; padding: 12px; margin: 8px 0; display: flex; align-items: center; justify-content: center;">
  ...
  editor.BlockManager.add('flutter-padding', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-padding" style="padding: 24px; background: #f5f5f5; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-listview', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-listview" style="width: 100%; max-height: 320px; overflow-y: auto; background: #f5f5f5; border-radius: 12px; padding: 12px; margin: 16px 0; -webkit-overflow-scrolling: touch;">
  ...
  editor.BlockManager.add('flutter-gridview', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-gridview" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 16px; width: 100%; padding: 12px; background: #f5f5f5; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-sizedbox', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-sizedbox" style="width: 80px; height: 80px; background: #f5f5f5; border: 2px dashed #bdbdbd; border-radius: 8px; margin: 16px auto; display: flex; align-items: center; justify-content: center;">
  ...
  editor.BlockManager.add('flutter-wrap', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-wrap" style="display: flex; flex-wrap: wrap; gap: 12px; width: 100%; padding: 12px; background: #f5f5f5; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-center', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-center" style="display: flex; align-items: center; justify-content: center; background: #f5f5f5; width: 100%; height: 100px; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-align', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-align" style="position: relative; width: 100%; height: 120px; background: #f5f5f5; border-radius: 12px; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-aspect-ratio', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-aspect-ratio" style="width: 100%; position: relative; padding-top: 56.25%; background: #f5f5f5; border-radius: 12px; overflow: hidden; margin: 16px 0;">
  ...
  editor.BlockManager.add('flutter-safe-area', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-safe-area" style="width: 100%; padding: 24px 16px; background: #e8eaf6; border-radius: 12px; margin: 16px 0; border: 2px dashed #9fa8da;">
  ...
  editor.BlockManager.add('flutter-flexible', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-flexible" style="flex: 2; background: #ffe082; min-height: 40px; border-radius: 12px; padding: 12px; margin: 8px 0; display: flex; align-items: center; justify-content: center;">
  ...
  editor.BlockManager.add('flutter-single-child-scroll-view', {
    ...
    category: layoutCategory,
    content: `
      <div data-gjs-type="flutter-single-child-scroll-view" style="width: 100%; max-height: 180px; overflow-y: auto; background: #f5f5f5; border-radius: 12px; padding: 12px; margin: 16px 0; -webkit-overflow-scrolling: touch;">
