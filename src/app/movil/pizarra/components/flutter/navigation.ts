...
export function addFlutterNavigationComponents(editor: any) {
  ...
  editor.BlockManager.add('flutter-nav-bottom-navigation-bar', {
    ...
    category: navigationCategory,
    content: `
      <nav data-gjs-type="flutter-nav-bottom-navigation-bar" style="height: 64px; background: #fff; border-top: 1px solid #e0e0e0; display: flex; justify-content: space-evenly; align-items: center; gap: 16px;">
  ...
  editor.BlockManager.add('flutter-nav-rail', {
    ...
    category: navigationCategory,
    content: `
      <nav data-gjs-type="flutter-nav-rail" style="width: 72px; min-height: 100vh; background: #f5f5f5; border-right: 1px solid #e0e0e0; display: flex; flex-direction: column; align-items: center; padding: 16px 0; gap: 16px;">
  ...
  editor.BlockManager.add('flutter-nav-drawer', {
    ...
    category: navigationCategory,
    content: `
      <aside data-gjs-type="flutter-nav-drawer" style="width: 260px; min-height: 100vh; background: #fff; box-shadow: 2px 0 8px rgba(0,0,0,0.08); border-radius: 0 18px 18px 0; padding: 24px 0; display: flex; flex-direction: column; gap: 12px;">
  ...
  editor.BlockManager.add('flutter-nav-tabbar', {
    ...
    category: navigationCategory,
    content: `
      <nav data-gjs-type="flutter-nav-tabbar" style="display: flex; gap: 8px; background: #f5f5f5; border-radius: 12px; padding: 8px 12px; margin: 12px 0;">
